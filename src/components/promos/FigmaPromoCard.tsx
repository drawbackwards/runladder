...
/**
 * Sidebar promo for Ladder for Figma. Status-aware: shows connect status and
 * an update hint at a glance, but the install/how-to lives on /dashboard/figma.
 *  - Not installed → "Get started"
 *  - Installed     → "Connected" pill + "Manage"
 *  - Update ready  → an "Update available" hint
 */
export function FigmaPromoCard() {
