...
| Pricing page (Free 5-lifetime, Pro $1,000/mo, Team Custom Beta) | Public | Live (v0.4.8 + v0.4.9, updated v0.5.4) | `src/app/pricing/page.tsx` — Team tier: added leaderboard, seat management bullets. Free CTA links to signup then `/dashboard`. Pro subscribe uses full-page Clerk redirect (not modal). |
| Products page — Ladder for Teams section | Public | Live (v0.5.4) | `src/app/products/page.tsx` — new card between AI Skill and Drawbackwards Consulting. Speaks to design leads and managers. |
| Homepage — Ladder for Teams in product suite grid | Public | Live (v0.5.4) | `src/app/page.tsx` — Teams added to product grid. Hero primary CTA now links to `/pricing`. |
