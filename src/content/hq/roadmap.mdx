...
| --- | --- | --- |
| Design System Compliance v1 ([#400](https://github.com/drawbackwards/runladder/issues/400)): plugin diffs scored frames against enabled Figma libraries, advisory findings on plugin + dashboard | Plugin + Web | In flight (target: functional by 2026-08-04 for the Chester → Michael handoff) |
...
| Priority | Surface | Notes |
| --- | --- | --- |
| Design System Compliance phases 2+ ([#400](https://github.com/drawbackwards/runladder/issues/400)): remaining drift checks (spacing/radius, instance overrides, deprecated components), Team-Lead library-connect flow (Option B), web-surface parity | Plugin + Web + API | ~3-month feature horizon; full candidate list + tier analysis recorded on the ticket |
